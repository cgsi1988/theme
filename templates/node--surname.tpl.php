...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <div class="content">
    ...
    <p>
      ...
      <?php print t('<strong>City/Village of Origin:</strong> @city<br/>', array('@city' => $field_fromlocation[0]['city'])); ?>
      <?php print t('<strong>European Country:</strong> @country<br/>', array('@country' => $field_fromlocation[0]['country'])); ?>
      <?php print t('<strong>Immigration area (US or other):</strong> @area<br/>', array('@area' => $field_tolocation[0]['city'])); ?>
    </p>
