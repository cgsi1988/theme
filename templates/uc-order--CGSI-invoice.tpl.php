      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td>
                  <img src="http://www.cgsi.org/sites/all/themes/cgsi/images/cgsi_tree.gif"/>
                </td>
                <td nowrap="nowrap">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php print t('Thank you for your order, !order_first_name!', array('!order_first_name' => $order_first_name)); ?></b></p>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#1c5124" style="color: white;">
              ...
              <tr>
                <td colspan="2">
                  ...
                  <?php if ($help_text): ?>
                  <p><?php print t('CGSI members can log in to our website and view their orders in the My Profile section. Log in now: http://www.cgsi.org/user'); ?></p>
                  <p><?php print t('If you are not a CGSI member, send your questions to Store Sales at sales@cgsi.org.'); ?></p>
                  <?php endif; ?>

                  <?php if ($email_text): ?>
                  <p><?php print t('Please note: This e-mail message is an automated notification. Please do not reply to this message. Send questions about your order to sales@cgsi.org.'); ?></p>

                  <p><?php print t('Thanks again for shopping with us.'); ?></p>
                  <?php endif; ?>

                  <?php if ($store_footer): ?>
                  <p><?php print $store_address; ?></p>
                  <?php endif; ?>
                </td>
              </tr>
              <?php endif; ?>
